...
- 工具设置中的全局项（`debug`、`autoAddEditorContextTags`、`autoCompactContextAfterRun`、`multiAgentEnabled`、`locale`、`macTaskShell`、`loopMaxRounds`、`loopSubtaskMaxThinkingMode`）写入 `~/.sinitek_cli/settings.json`。
