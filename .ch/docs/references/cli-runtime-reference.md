...
实现与回归事实来源：`src/loopSkillGuidance.ts`、`src/extension.ts`、`src/loopTaskStore.ts`、`src/loopPromptBuilders.ts`、`src/loopDebateRunner.ts`、`src/test/loopSkillGuidance.test.ts`、`src/test/loopSkillIntegration.test.ts`、`src/test/loopTaskStore.test.ts`、`src/test/loopPromptBuilders.test.ts`。
