...
- `.ch/docs/product-specs/`：系统当前用户承诺、功能总表和验收事实源；入口为 `.ch/docs/product-specs/FEATURE_INVENTORY.md`，按需保留少数当前能力分册。
...
- 功能清单入口：`.ch/docs/product-specs/FEATURE_INVENTORY.md` 是功能总表；单项规格按需放在 `.ch/docs/product-specs/`，任务收尾是否更新清单见 `.ch/docs/exec-plans/README.md`。
...
- `.ch/docs/product-specs/`：一个功能总表、少数当前能力分册、用例、范围和验收文档。
...
- product specs 可以很薄，但不能被 ontology 或执行计划替代；它回答系统现在对用户承诺什么。
