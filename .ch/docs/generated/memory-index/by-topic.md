...
- 直接引用：`.ch/docs/generated/`, `.ch/docs/ontology/`
...
- Freshness：`starter`
- Read：~18 tokens
- 摘要：这个文件是记忆金字塔的 **L2**：从滚动摘要、执行计划和 runbook 中抽取重要事件。
...
- 直接引用：`.ch/docs/MEMORY.md`, `.ch/docs/generated/memory-index/`, `.ch/docs/generated/memory-index/.local/`
