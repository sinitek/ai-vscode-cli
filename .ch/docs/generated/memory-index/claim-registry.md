...
- Text: 记忆流转规则: doc_type = memory_rules
- Type: `instruction`
- Status: `active`
- Confidence: `high`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `记忆流转规则`
- Source span: `front matter:doc_type`
...
- Text: 记忆流转规则: scope = global
- Type: `fact`
- Status: `active`
- Confidence: `high`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `记忆流转规则`
- Source span: `front matter:scope`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Text: 记忆流转规则: source_of_truth = .ch/docs/MEMORY.md
- Type: `fact`
- Status: `active`
- Confidence: `high`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `记忆流转规则`
- Source span: `front matter:source_of_truth`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Text: 记忆流转规则: status = active
- Type: `decision`
- Status: `active`
- Confidence: `high`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `记忆流转规则`
- Source span: `front matter:status`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Text: 本轮没有完成但确定要继续的事项
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `2.1 当前任务事实`
- Source span: `heading:2.1 当前任务事实`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Text: 已验证、但暂时还不值得扩展成完整设计文档或 runbook 的经验
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `2.2 跨会话仍要先读的信息`
- Source span: `heading:2.2 跨会话仍要先读的信息`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Text: 涉及分层边界、依赖方向、数据流、权限模型
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `2.3 稳定设计结论`
- Source span: `heading:2.3 稳定设计结论`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Text: `runbooks/PITFALLS.md` 及其子文件
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `2.5 复发问题和长期规避动作`
- Source span: `heading:2.5 复发问题和长期规避动作`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `2.7 滚动摘要和事件记忆`
- Source span: `heading:2.7 滚动摘要和事件记忆`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `3. 上提触发条件`
- Source span: `heading:3. 上提触发条件`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Text: `memory_type` 用来标识这份记忆文档承载的语义。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `3.1 长期记忆文档 front matter`
- Source span: `heading:3.1 长期记忆文档 front matter`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Text: `status` 不是可选装饰；一旦文档失效或被替代，应明确标成 `superseded` 或 `archived`。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: `source_of_truth` 必须指向真正负责这类事实的文档或归属。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: `derived_from`、`supersedes`、`related_paths` 可以先为空，但字段应保留，便于后续机械处理。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: `last_verified_at` 用来支撑 freshness 检查。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 标签内内容不会进入 `memory-indexer` 生成的 recall index、observation registry、timeline 或 topic corpus。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 如果整份文档不应进入记忆索引，可在 front matter 中写 `memory_visibility: private` 或 `private: true`。
- Type: `decision`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 隐私标签不是密钥管理方案；密钥、令牌、生产地址、客户数据仍不应写入仓库。
- Type: `decision`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 如果某条记忆的来源包含被剥离的隐私段，应保留非敏感摘要和事实来源，不要把敏感内容改写进摘要。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: `type`：`risk`、`pending`、`event`、`lesson`、`context`、`preference`、`plan`、`summary`、`rule` 等
- Type: `risk`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `3.3 ID 化 observation registry`
- Source span: `heading:3.3 ID 化 observation registry`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Text: `id`：稳定的 `mem-<hash>` 形式，用于 recall 和 timeline anchor
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: claim-lite 必须 claim-aware，但仍然 source-first；没有来源锚点的 claim 不应作为稳定输入长期存在。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `3.4 Claim-aware index 的最小规则`
...
- Text: `needs_verification`、`superseded`、`archived` 的 claim 可以保留在 generated 索引中，但不应继续被默认视作高优先 recall 输入。
- Type: `decision`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 第一阶段只要求最小字段和可审阅证据，不要求三元组、本体、图数据库或外部语义服务。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: `timeline.md`：按时间和来源排列 observation entries
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `3.5 Timeline 与 topic corpus`
...
- Text: 不要把 generated corpus 本身当成唯一事实来源复制到其他仓库。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 需要围绕某条记忆恢复前后文时，运行 `memory-recall --anchor-id <mem-id>`。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: `topic-corpus.md`：按 topic 聚合可复用知识
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: `LESSONS_LEARNED.md` 中如果已经上提成稳定设计、runbook 或 skill，应改成短链接或删除重复条目。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
- Source anchor: `4. 清理与降级规则`
- Source span: `heading:4. 清理与降级规则`
- Source observation: `mem-c1d7e714b7`
- Content hash: `sha256:c1d7e714b7e6c4976f0acfe2caff3fd8bfa441accb5b8b14f663d6735c3e709e`
...
- Text: claim-lite 一旦进入 `superseded`、`archived` 或 `needs_verification`，应从默认高优先召回输入降级，并在必要时等待 proposal 或人工确认后再更新长期事实来源。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: `exec-plans/active/` 完成后，应决定哪些内容上提，哪些只归档。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: `PENDING_ITEMS.md` 中完成的事项应及时删除，或迁到已完成计划中留痕。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: `ACTIVE_RISKS.md` 中已关闭的风险应移除；如果仍有长期复盘价值，迁入 runbook 或历史文档。
- Type: `risk`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 是否有内容应标记为 `<private>` 或 `memory_visibility: private`，避免进入 generated recall 面
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 是否出现了新的用户可见行为变化，应该更新 `product-specs/` 和 `FEATURE_INVENTORY.md`
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 是否出现了新的稳定项目事实或用户偏好，应上提到 L3 `PROJECT_CONTEXT.md` / `USER_PREFERENCES.md`
- Type: `preference`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 是否出现了新的失败原因、成功方案或关键决策，应抽取到 L2 `EVENT_MEMORY.md`
- Type: `decision`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 是否出现了新的稳定设计结论，应该写入 `design-docs/`
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 如果当前仓库已启用 claim-aware index，claim-lite 是否缺少 `status`、来源锚点或 `review_after`
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 是否出现了新的复发问题，应该进入 `runbooks/`
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 是否有重复机械动作，值得提炼成 L4 `skill` 或 `python3` 脚本
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/MEMORY.md`
...
- Text: 热区记忆面: doc_type = memory_index_rules
- Type: `fact`
- Status: `active`
- Confidence: `high`
...
- Text: 热区记忆面: source_of_truth = .ch/docs/memory/README.md
- Type: `fact`
- Status: `active`
- Confidence: `high`
- Source: `.ch/docs/memory/README.md`
...
- Text: `memory-recall` 会先展示 observation index，再少量展开详情；需要前后文时可用 `--anchor-id <mem-id>` 生成 timeline window。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 这些热区文件本身仍然是 Markdown 事实来源。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `memory-indexer` 会从热区、active plans、pending items、active risks 和 lessons 生成 ID 化 observation registry，并估算读取成本。
- Type: `risk`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 围绕它们的 recall、consolidation、freshness check 等流程，允许通过 `skills` 调用 `python3` 脚本来做结构化提取、校验和收口。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `runbooks/`：放可执行操作法、排障和长期规避动作。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
- Source anchor: `与其他目录的边界`
- Source span: `heading:与其他目录的边界`
- Source observation: `mem-431f2548e1`
- Content hash: `sha256:431f2548e168fff0575bcb89614492ce054a6dae45f0abc5ea500b41f5381c1e`
...
- Text: `product-specs/`：放业务目标、范围和验收。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `design-docs/`：放“为什么这样设计”的稳定决策。
- Type: `decision`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `exec-plans/`：放任务推进过程、阶段状态、验证和下一步。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `USER_PREFERENCES.md`：不超过 15 条明确偏好
- Type: `preference`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
- Source anchor: `体积控制`
- Source span: `heading:体积控制`
- Source observation: `mem-431f2548e1`
- Content hash: `sha256:431f2548e168fff0575bcb89614492ce054a6dae45f0abc5ea500b41f5381c1e`
...
- Text: `LESSONS_LEARNED.md`：不超过 20 条稳定经验
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `PENDING_ITEMS.md`：不超过 20 条开放事项
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `EVENT_MEMORY.md`：不超过 30 条重要事件
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `ROLLING_SUMMARY.md`：不超过 10 条阶段摘要
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `PROJECT_CONTEXT.md`：不超过 20 条有效要点
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `ACTIVE_RISKS.md`：不超过 15 条有效风险
- Type: `risk`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 热区记忆只保留**高密度、高复用、短时必须先读**的信息。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
- Source anchor: `使用原则`
- Source span: `heading:使用原则`
- Source observation: `mem-431f2548e1`
- Content hash: `sha256:431f2548e168fff0575bcb89614492ce054a6dae45f0abc5ea500b41f5381c1e`
...
- Text: 如果一条信息只适用于单次任务，不要写进热区，优先写到当前 `exec plan`。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 长期记忆文档默认应带统一 front matter，具体字段见 `.ch/docs/MEMORY.md`。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 不把长过程、长讨论、整段日志直接堆进这里；那些内容应回到原始文档。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 失效、过期、已关闭的内容要尽快删除，或迁回原始文档归档，不让热区持续膨胀。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 每条内容都应能指回更完整的事实来源，例如执行计划、设计文档、规格、runbook、代码路径。
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 如果一条信息已经从 L1/L2 上提到 L3/L4，应清理低层重复文本，只保留必要短链接。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 再跳转到关联的 `exec-plans/`、`design-docs/`、`runbooks/`、`product-specs/`
- Type: `instruction`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
- Source anchor: `推荐阅读顺序`
- Source span: `heading:推荐阅读顺序`
- Source observation: `mem-431f2548e1`
- Content hash: `sha256:431f2548e168fff0575bcb89614492ce054a6dae45f0abc5ea500b41f5381c1e`
...
- Text: `ROLLING_SUMMARY.md`：L1 滚动摘要。压缩较旧、分散但仍有跨会话价值的阶段信息。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
- Source anchor: `文件分工`
- Source span: `heading:文件分工`
- Source observation: `mem-431f2548e1`
- Content hash: `sha256:431f2548e168fff0575bcb89614492ce054a6dae45f0abc5ea500b41f5381c1e`
...
- Text: `PENDING_ITEMS.md`：跨会话未完成事项、明确承诺和后续跟进点。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `EVENT_MEMORY.md`：L2 事件记忆。记录失败原因、成功方案、迁移/回滚/事故/关键决策等重要事件。
- Type: `decision`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `ACTIVE_RISKS.md`：当前仍有效、尚未关闭的风险和观察点。
- Type: `risk`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `LESSONS_LEARNED.md`：已验证、值得复用的经验与反模式结论。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `USER_PREFERENCES.md`：用户明确表达过、希望长期保持的协作和实现偏好。
- Type: `preference`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: `PROJECT_CONTEXT.md`：项目级稳定上下文。记录跨模块约束、关键路径、核心命令、长期有效的结构结论。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 不允许进入长期记忆或 generated recall 面的内容，用 `<private>...</private>` 或 `<no-memory>...</no-memory>` 包裹。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
- Source anchor: `隐私边界`
- Source span: `heading:隐私边界`
- Source observation: `mem-431f2548e1`
- Content hash: `sha256:431f2548e168fff0575bcb89614492ce054a6dae45f0abc5ea500b41f5381c1e`
...
- Text: 整份文档不应被索引时，在 front matter 写 `memory_visibility: private` 或 `private: true`。
- Type: `decision`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
...
- Text: 被隐私标签包裹的内容会被脚本剥离；不要在摘要、事实或来源字段中重新写入敏感内容。
- Type: `fact`
- Status: `active`
- Confidence: `medium`
- Source: `.ch/docs/memory/README.md`
