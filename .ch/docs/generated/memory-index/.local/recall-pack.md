...
- Focus: final_answer 最终回复气泡 任务中断 grok-4.6-kedaya abort cleanup fetch effects
- Anchor ID: -
...
- `.ch/docs/design-docs/loop-debate-multi-agent-mode.md` | Loop 红蓝辩论多智能体模式详细设计 | matches=最终, 气泡
  Why: 与当前 focus 相关的设计决策入口，命中：最终 / 气泡。
