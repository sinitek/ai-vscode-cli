...
- Score breakdown: type_priority=45, focus_terms=0, open_loop_bonus=0, read_cost_adjustment=4, evidence_bonus=5, concept_bonus=1, topic_bonus=2, source_diversity_bonus=2, claim_bonus=4, same_source_penalty=0
- Concepts: `gotcha`
...
- Score: `62` (base `56`)
- Selected claims: `claim-04d77e38d577`, `claim-0b54f47ce76f`, `claim-0b87a7723e07`, `claim-13080f25ffe8`, `claim-16cc09133222`, `claim-1cf94165b719` ... (+76 more)
...
- `.ch/docs/MEMORY.md` | 记忆流转规则 | matches=ai
  Why: 记忆分层与流转规则入口。
...
- `.ch/docs/design-docs/graph-orchestration-mode.md` | Graph 编排模式详细设计 | matches=opencode, ai
  Why: 与当前 focus 相关的设计决策入口，命中：opencode / ai。
...
- `.ch/docs/design-docs/vscode-cli-extension-runtime.md` | VS Code CLI 插件运行时架构 | matches=tab, ai
  Why: 与当前 focus 相关的设计决策入口，命中：tab / ai。
...
- `.ch/docs/runbooks/local-development.md` | 本地开发与打包手册 | matches=opencode
  Why: 与当前 focus 相关的排障或规避动作入口，命中：opencode。
