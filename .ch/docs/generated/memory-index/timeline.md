...
| `mem-4b483bd801` | 2026-07-11T03:33:13+00:00 | `plan` | MCP 市场全量检测与权威刷新 | `.ch/docs/exec-plans/active/2026-07-11-mcp-market-refresh.md` | ~119 |
| `mem-5233a00937` | 2026-07-13T04:55:42+00:00 | `plan` | Codex、Claude、OpenCode CLI 配置可视化扩展 | `.ch/docs/exec-plans/active/2026-07-12-cli-config-visualization.md` | ~107 |
| `mem-e2fabd8a2e` | 2026-07-14T01:27:53+00:00 | `plan` | Loop Group Chat UI Follow-ups | `.ch/docs/exec-plans/active/2026-06-25-loop-group-chat-ui-followups.md` | ~48 |
