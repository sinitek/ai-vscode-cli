...
def main() -> int:
    ...
    generated_at = normalize_generated_at(str(memory_summary.get("generated_at", "") or ""))
    generated_docs = build_generated_entries(display_output_dir, memory_summary, consolidation_summary, generated_at)
