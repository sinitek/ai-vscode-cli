...
export const WEBVIEW_I18N = {
  ...
  "zh-CN": {
    ...
    helpModeLoopPlusPros: "优点：一个子任务执行结束就立即开始验收；验收期间其它完成进入可见队列，再逐个验收。验收后可以追加任务；没有新任务但仍有任务在运行时继续等待。说话会唤醒主任务；主任务已经在执行时消息进入队列，之后一起查看，并决定立刻发起子任务，或等某个在途子任务结束后再发起。",
    helpModeGraphTitle: "Graph",
