...
export const WEBVIEW_I18N = {
  en: {
    ...
    helpModeGraphBest: "Best for complex work needing explicit nodes, dependencies, parallel batches, checkpoints, and visible evidence.",
  ...
  "zh-CN": {
    ...
    helpModeGraphTitle: "Graph",
    helpModeGraphBest: "适合：复杂任务，需要明确节点、依赖、并行批次、检查点和证据可视化时使用。",
