...
export const WEBVIEW_I18N = {
  en: {
    ...
    helpModeLoopBest: "Best for medium or large tasks that benefit from main/sub agents, review rounds, or debate.",
    helpModeLoopPros: "Pros: decomposes work into subtask chats, keeps group-chat context, and supports iterative review.",
    ...
    helpModeGraphCons: "Cons: highest setup cost and UI complexity; still no graph editor or automatic conflict resolution.",
  ...
  "zh-CN": {
    ...
    helpModeLoopTitle: "Loop",
    helpModeLoopBest: "适合：中大型任务，需要主从子任务、多轮复核或红蓝辩论时使用。",
    helpModeLoopPros: "优点：能拆成子任务对话，保留群聊上下文，适合反复执行、复核和补充需求。",
    ...
    helpModeGraphCons: "缺点：准备成本和界面复杂度最高；目前还没有图编辑器或自动解冲突能力。",
