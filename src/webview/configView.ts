...
const CONFIG_TRANSLATIONS_EN: Record<string, string> = {
  ...
  "模型候选仅来自当前配置；可输入内置、未声明或旧的 provider/model 引用。": "Model suggestions come only from this config. Built-in, undeclared, and legacy provider/model references remain editable.",
  "主模型 model": "Primary model",
  "小模型 small_model": "Small model",
