...
const WEBVIEW_I18N = {
  en: {
    ...
    toolSettingsLongTermMemoryTitle: "Workspace setting. Provides a repo-local AI collaboration scaffold with memory, pitfalls, handoffs, skills, and CodeGraph-assisted code navigation.",
    toolSettingsLongTermMemoryToggle: "On",
    toolSettingsLongTermMemoryHint: "Off by default. Turn it on to initialize a workspace-local Harness for long-running context, reusable agent guidance, pitfall capture, task handoffs, and code exploration.",
  ...
  "zh-CN": {
    ...
    toolSettingsLongTermMemoryTitle: "工作区设置。提供仓库本地 AI 协作骨架，支持长期记忆、踩坑沉淀、任务交接、技能约定和 CodeGraph 辅助代码导航。",
    toolSettingsLongTermMemoryToggle: "开启",
    toolSettingsLongTermMemoryHint: "默认关闭。开启后可为当前工作区初始化 Harness，用于沉淀长周期上下文、复用代理工作规范、记录踩坑、交接任务并提升代码探索效率。",
