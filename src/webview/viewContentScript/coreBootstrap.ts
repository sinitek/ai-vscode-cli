...
export const VIEW_CONTENT_SCRIPT_CORE_BOOTSTRAP = `      const vscode = acquireVsCodeApi();
      ...
      const elements = {
        ...
        codeGraphEnabled: document.getElementById("codeGraphEnabled"),
        codeGraphNote: document.getElementById("codeGraphNote"),
        toolSettingsGeneralTab: document.getElementById("toolSettingsGeneralTab"),
        toolSettingsAiTaskTab: document.getElementById("toolSettingsAiTaskTab"),
        toolSettingsWorkspaceTab: document.getElementById("toolSettingsWorkspaceTab"),
        toolSettingsRepairTab: document.getElementById("toolSettingsRepairTab"),
        toolSettingsGeneralPanel: document.getElementById("toolSettingsGeneralPanel"),
        toolSettingsAiTaskPanel: document.getElementById("toolSettingsAiTaskPanel"),
        toolSettingsWorkspacePanel: document.getElementById("toolSettingsWorkspacePanel"),
        toolSettingsRepairPanel: document.getElementById("toolSettingsRepairPanel"),
        toolSettingsRepairTable: document.getElementById("toolSettingsRepairTable"),
        toolSettingsRepairBody: document.getElementById("toolSettingsRepairBody"),
        toolSettingsRepairEmpty: document.getElementById("toolSettingsRepairEmpty"),
        ...
        scheduledTaskError: document.getElementById("scheduledTaskError"),
        saveScheduledTask: document.getElementById("saveScheduledTask"),
        ...
        humanInteractionOverlay: document.getElementById("humanInteractionOverlay"),
        closeHumanInteraction: document.getElementById("closeHumanInteraction"),
        humanInteractionTitle: document.getElementById("humanInteractionTitle"),
        humanInteractionInstruction: document.getElementById("humanInteractionInstruction"),
        humanInteractionForm: document.getElementById("humanInteractionForm"),
        humanInteractionError: document.getElementById("humanInteractionError"),
        humanInteractionSubmit: document.getElementById("humanInteractionSubmit"),
        humanInteractionReject: document.getElementById("humanInteractionReject"),
      ...
      const RUN_STREAM_MAX_RECORD_BYTES = 256 * 1024;
