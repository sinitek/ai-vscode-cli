...
const STRINGS = {
  en: {
    ...
    stopTask: "Stop",
    stopTaskTitle: "Stop this Loop task and cancel any scheduled wake-up",
    task: "Task",
    status: "Status",
    cli: "CLI",
    ...
    autoSleep: "Automatic sleep",
    wakeCountdown: "Wakes in",
    scheduledWakeAt: "Scheduled wake",
    sleepReason: "Reason",
    wakeDue: "Waking now",
    daySuffix: "d",
  ...
  "zh-CN": {
    ...
    continueCancel: "取消",
    stopTask: "中止",
    stopTaskTitle: "中止当前 Loop 任务并取消计划唤醒",
    task: "任务",
    status: "状态",
    cli: "CLI",
    currentRound: "当前轮次",
    updatedAt: "更新时间",
    sleepingStatus: "自动睡眠中",
    autoSleep: "自动睡眠",
    wakeCountdown: "距离唤醒",
    scheduledWakeAt: "计划唤醒",
    sleepReason: "等待原因",
    wakeDue: "正在唤醒",
    daySuffix: "天",
    participants: "成员",
