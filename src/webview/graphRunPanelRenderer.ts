...
const STRINGS = {
  en: {
    ...
    continueDialogTitle: "Choose models to continue",
    continueDialogDescription: "Keep this run's original main and subtask models, or switch to the models currently configured for Loop mode.",
    continueModelChoiceLabel: "Main and subtask models",
    continueModelOriginal: "Keep the original models",
    continueModelOriginalHint: "Continue with the main and subtask models already bound to this run.",
    continueModelOriginalUnavailable: "This run has no recorded main and subtask models, so the original choice is unavailable.",
    ...
    zoomLevel: "Zoom",
    centerRunningNode: "Center running node",
    centerRunningNodeTitle: "Center the currently running Graph node in the canvas",
    centerRunningNodeUnavailable: "No running Graph node is available to center",
  ...
  "zh-CN": {
    ...
    continueDialogTitle: "选择继续使用的模型",
    continueDialogDescription: "可以保持这个运行原来的主/子模型，或改用当前 Loop 模式配置的主/子模型。",
    continueModelChoiceLabel: "继续使用的主/子模型",
    continueModelOriginal: "保持原主子模型",
    continueModelOriginalHint: "沿用这个运行已经绑定的主模型和子模型继续。",
    continueModelOriginalUnavailable: "这个运行没有记录启动时的主/子模型，不能保持原模型。",
    ...
    graphTools: "运行图工具",
    zoomLevel: "缩放",
    centerRunningNode: "定位运行节点",
    centerRunningNodeTitle: "将正在运行的 Graph 节点定位到画布中间",
    centerRunningNodeUnavailable: "当前没有正在运行的 Graph 节点可定位",
    selectedNode: "已选节点",
    closeDetails: "关闭详情",
