...
const STRINGS = {
  en: {
    ...
    humanApprovalTitle: "Human approval required",
    humanApprovalDescription: "This Graph run is waiting at a human gate. Review the node evidence, then approve from this panel.",
    humanApprovalCta: "Please approve, click here",
    stopRun: "Stop Run",
  ...
  "zh-CN": {
    ...
    humanApprovalTitle: "需要人工审批",
    humanApprovalDescription: "当前 Graph 运行正在人工关卡等待。请先查看节点证据，再从本面板批准。",
    humanApprovalCta: "请你审批，点击这里",
    stopRun: "中止运行",
