...
const MESSAGES = {
  en: {
    ...
    "run.loopAutoSleepTitle": "Automatic sleep scheduled",
    "run.loopAutoSleepReason": "Reason: {reason}",
    "run.loopAutoSleepReasonUnknown": "Waiting for an external result.",
    "run.loopAutoWakeAt": "Scheduled wake time: {time}",
    "run.loopAutoWakeTimeUnknown": "Unknown",
    "run.loopAutoWakePrompt": "The scheduled wake time for Loop task {taskId} has arrived. Recheck the awaited result and continue from the current Loop round.",
  ...
  "zh-CN": {
    ...
    "run.loopAutoSleepTitle": "已进入自动睡眠等待定时唤醒",
    "run.loopAutoSleepReason": "等待原因：{reason}",
    "run.loopAutoSleepReasonUnknown": "等待外部结果。",
    "run.loopAutoWakeAt": "计划唤醒时间：{time}",
    "run.loopAutoWakeTimeUnknown": "未知",
    "run.loopAutoWakePrompt": "Loop 任务 {taskId} 的定时唤醒时间已到。请重新检查等待结果，并从当前 Loop 轮次继续执行。",
