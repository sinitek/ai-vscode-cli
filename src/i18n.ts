...
const MESSAGES = {
  en: {
    ...
    "run.lobsterSubtaskWaiting": "The Loop subtask is running. No displayable assistant output is available yet; progress synchronization will continue.",
    ...
    "run.lobsterResumed": "Loop task resumed: {taskId}\nContinue from round: {round}\nRecord file: {file}",
    "run.lobsterResumeUnavailableStartNew": "No resumable Loop task was found in this tab. A new Loop task will be started.",
    "lobsterDebateChat.noTask": "No Loop task was found.",
    "lobsterDebateChat.noTranscript": "No readable Loop group chat transcript is available.",
    "lobsterDebateChat.noTaskRecord": "No readable Loop task record is available.",
    "lobsterDebateChat.taskMissing": "Loop task not found: {taskId}",
    "lobsterDebateChat.selectTask": "Select a Loop task",
    "lobsterDebateChat.openTranscript": "Open Loop group chat transcript",
    "lobsterDebateChat.transcriptMissing": "Transcript file is missing or empty: {path}",
    "lobsterDebateChat.continueUnavailable": "This Loop task cannot be continued.",
    "lobsterDebateChat.continueAlreadyRunning": "This Loop task is already running.",
    "lobsterDebateChat.stopUnavailable": "No running task was found for this Loop group chat.",
  ...
  "zh-CN": {
    ...
    "run.lobsterSubtaskWaiting": "Loop 子任务正在执行，暂未产生可展示的助手输出；插件会继续同步进度。",
    ...
    "run.lobsterResumed": "已恢复 Loop 任务：{taskId}\n继续轮次：第 {round} 轮\n记录文件：{file}",
    "run.lobsterResumeUnavailableStartNew": "当前标签未找到可继续的 Loop 任务，将新建一个 Loop 任务。",
    "lobsterDebateChat.noTask": "未找到 Loop 任务。",
    "lobsterDebateChat.noTranscript": "暂无可读取的 Loop 群聊 transcript。",
    "lobsterDebateChat.noTaskRecord": "暂无可读取的 Loop 任务记录。",
    "lobsterDebateChat.taskMissing": "未找到 Loop 任务：{taskId}",
    "lobsterDebateChat.selectTask": "选择一个 Loop 任务",
    "lobsterDebateChat.openTranscript": "打开 Loop 群聊 transcript",
    "lobsterDebateChat.transcriptMissing": "群聊 transcript 文件缺失或为空：{path}",
    "lobsterDebateChat.continueUnavailable": "当前 Loop 任务无法继续。",
    "lobsterDebateChat.continueAlreadyRunning": "当前 Loop 任务已在执行中。",
    "lobsterDebateChat.stopUnavailable": "当前 Loop 群聊没有正在运行的任务可中止。",
    "run.completed": "任务已完成",
