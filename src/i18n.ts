...
const MESSAGES = {
  en: {
    ...
    "workspaceHarness.confirmInitialize": "Initialize the workspace harness scaffold for {workspace}? This will install .ch, .agents, ARCHITECTURE.md, AGENTS.md, CLAUDE.md, and start CodeGraph setup in a terminal.",
  ...
  "zh-CN": {
    ...
    "workspaceHarness.confirmInitialize": "是否为 {workspace} 初始化工作区 harness 骨架？这会安装 .ch、.agents、ARCHITECTURE.md、AGENTS.md、CLAUDE.md，并在终端启动 CodeGraph 设置。",
