...
const MESSAGES = {
  en: {
    ...
    "compact.geminiNativeCompressed": "Gemini context compaction completed for current session: {sessionId}",
  ...
  "zh-CN": {
    ...
    "compact.geminiNativeCompressed": "Gemini 当前会话上下文压缩已完成：{sessionId}",
    "tool.inputLabel": "输入",
    "tool.outputLabel": "输出",
