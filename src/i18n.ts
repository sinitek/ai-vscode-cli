...
const MESSAGES = {
  en: {
    ...
    "run.lobsterResumed": "🦞 Resumed lobster task: {taskId}\nContinue from round: {round}\nRecord file: {file}",
    "run.lobsterResumeUnavailableStartNew": "🦞 No resumable lobster task was found in this tab. A new lobster task will be started.",
    "lobsterDebateChat.noTask": "No lobster task was found.",
    "lobsterDebateChat.noTranscript": "No readable lobster group chat transcript is available.",
    "lobsterDebateChat.noTaskRecord": "No readable lobster task record is available.",
    "lobsterDebateChat.taskMissing": "Lobster task not found: {taskId}",
    "lobsterDebateChat.selectTask": "Select a lobster task",
    "lobsterDebateChat.openTranscript": "Open lobster group chat transcript",
    "lobsterDebateChat.transcriptMissing": "Transcript file is missing or empty: {path}",
    "lobsterDebateChat.continueUnavailable": "This lobster task cannot be continued.",
    "lobsterDebateChat.continueAlreadyRunning": "This lobster task is already running.",
    "lobsterDebateChat.stopUnavailable": "No running task was found for this Lobster group chat.",
    ...
    "workspaceHarness.confirmArchitectureInitialize": "Initialize ARCHITECTURE.md with AI now? This will switch the current AI conversation to coding mode and start a task using the selected CLI group and configuration.",
  ...
  "zh-CN": {
    ...
    "run.lobsterResumed": "🦞 已恢复龙虾任务：{taskId}\n继续轮次：第 {round} 轮\n记录文件：{file}",
    "run.lobsterResumeUnavailableStartNew": "🦞 当前标签未找到可继续的龙虾任务，将新建一个龙虾任务。",
    "lobsterDebateChat.noTask": "未找到龙虾任务。",
    "lobsterDebateChat.noTranscript": "暂无可读取的龙虾群聊 transcript。",
    "lobsterDebateChat.noTaskRecord": "暂无可读取的龙虾任务记录。",
    "lobsterDebateChat.taskMissing": "未找到龙虾任务：{taskId}",
    "lobsterDebateChat.selectTask": "选择一个龙虾任务",
    "lobsterDebateChat.openTranscript": "打开龙虾群聊 transcript",
    "lobsterDebateChat.transcriptMissing": "群聊 transcript 文件缺失或为空：{path}",
    "lobsterDebateChat.continueUnavailable": "当前龙虾任务无法继续。",
    "lobsterDebateChat.continueAlreadyRunning": "当前龙虾任务已在执行中。",
    "lobsterDebateChat.stopUnavailable": "当前龙虾群聊没有正在运行的任务可中止。",
    "run.completed": "任务已完成",
    ...
    "workspaceHarness.confirmArchitectureInitialize": "是否现在让 AI 初始化 ARCHITECTURE.md？这会把当前 AI 对话切到编码模式，并使用当前选择的分组和配置发起任务。",
