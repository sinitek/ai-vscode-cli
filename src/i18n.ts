...
const MESSAGES = {
  en: {
    ...
    "run.hiddenRetryQueued": "Task interrupted. Automatic retry {attempt}/{attempts} will start in {seconds} seconds.",
  ...
  "zh-CN": {
    ...
    "run.hiddenRetryQueued": "任务已中断，将在 {seconds} 秒后开始第 {attempt}/{attempts} 次自动重试。",
